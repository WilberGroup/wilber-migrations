...
class CreateTrainingClaimsResults extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('training_claims_results', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('training_claim_id')->unsigned()->index();
    ...
    {
        Schema::dropIfExists('training_claims_results');
    }
}
